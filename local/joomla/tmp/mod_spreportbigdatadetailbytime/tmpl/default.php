 ...
 * @subpackage  mod_spselectcampaigndetailbytime
 *
...
$document->addScript('/media/mod_spreportbigdatadetailbytime/js/spreportbigdatadetailbytime.js');
...
<div class="col-md-12 col-sm-12 ">
    <p>
        <a class="btn btn-outline-secondary" data-toggle="collapse" href="#collapseSelect" role="button" aria-expanded="false" aria-controls="collapseSelect">
            <?php echo JText::_('MOD_SPREPORTBIGDATADETAILBYTIME');?>
        </a>
    </p>
...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        <div class="x_title">
            <h2><?php echo JText::_('MOD_SPREPORTBIGDATADETAILBYTIME_DETAIL');?> <small></small></h2>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr class="headings">
                                ...
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILBYTIME_HOUR'); ?></th>
