...
class SpsensorController extends JControllerLegacy
{
	...
	function display($cachable = false, $urlparams = false)
	{
		...
		$view		= $this->input->getCmd('view', 'listsensor');
		...
		if($isEdit)
		{
			if ($layout == 'edit' && !$this->checkEditId('com_spsensor.edit.'.$view, $id))
			{
				...
				else
				{
					...
					$this->setRedirect(JRoute::_('index.php?option=com_spsensor&view=listsensor', false));
				}
				return false;
			}
		}
		...
		if (SpsensorHelper::checkArray($urlparams))
		{
			$safeurlparams = SpsensorHelper::mergeArrays(array($urlparams, $safeurlparams));
		}
