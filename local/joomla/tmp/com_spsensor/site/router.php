...
/**
 * Routing class from com_spsensor
 *
 * @since  3.3
 */
class SpsensorRouter extends JComponentRouterBase
{	
	/**
	 * Build the route for the com_spsensor component
	 *
	...
	protected function getVar($table, $where = null, $whereString = null, $what = null, $category = false, $operator = '=', $main = 'spsensor')
	{
...
function SpsensorBuildRoute(&$query)
{
	$router = new SpsensorRouter;
	
	return $router->build($query);
}

function SpsensorParseRoute($segments)
{
	$router = new SpsensorRouter;
