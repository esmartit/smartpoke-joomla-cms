...
/**
 * Spsensor View class for the Itemsensor
 */
class SpsensorViewItemsensor extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_spsensor/assets/css/itemsensor.css', (SpsensorHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		$help_url = SpsensorHelper::getHelpUrl('itemsensor');
