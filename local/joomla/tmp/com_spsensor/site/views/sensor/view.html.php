...
//			$this->document->addStyleSheet(JURI::root() . "administrator/templates/isis/css/template.css", (SpsensorHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
//			$this->document->addScript(JURI::root() . "administrator/templates/isis/js/template.js", (SpsensorHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript');
//		}
		// the default style of this view
		$this->document->addStyleSheet(JURI::root()."components/com_spsensor/assets/css/sensor.css", (SpsensorHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		...
		$this->document->addScript(JURI::root(). "components/com_spsensor/views/sensor/submitbutton.js", (SpsensorHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript');
