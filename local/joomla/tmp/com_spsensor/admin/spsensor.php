...
// Access check.
if (!JFactory::getUser()->authorise('core.manage', 'com_spsensor'))
{
...
$document->addStyleSheet('components/com_spsensor/assets/css/admin.css');
$document->addScript('components/com_spsensor/assets/js/admin.js');
