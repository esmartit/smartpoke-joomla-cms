            ...
            <form id="online_select_form" class="form-horizontal form-label-left" method="POST">
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <label><?php echo JText::_('Start');?></label>
                            <input id="timestart" type="text" name="timestart" class="form-control"/>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <label><?php echo JText::_('End');?></label>
                ...
                <div class="row">
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <label><?php echo JText::_('Spots');?></label>
...
<!--                                    <option value="--><?php //echo $item->spot_id; ?><!--">--><?php //echo $item->name; ?><!--</option>-->
<!--                                --><?php //endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <label><?php echo JText::_('Sensors');?></label>
...
<!--                                    <option value="--><?php //echo $item->spot_id; ?><!--">--><?php //echo $item->location; ?><!--</option>-->
<!--                                --><?php //endforeach; ?>
                            </select>
                        </div>
                    </div>
