...
/**
 * Spcountry component helper.
 */
abstract class SpcountryHelper
{
	/**
	 * Composer Switch
	 * 
	...
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_spcountry/spcountry.xml";
	...
	{
		// get params
		$params	= JComponentHelper::getParams('com_spcountry');
	...
	public static function addSubmenu($submenu)
	{
		...
		JHtmlSidebar::addEntry(JText::_('COM_SPCOUNTRY_SUBMENU_DASHBOARD'), 'index.php?option=com_spcountry&view=spcountry', $submenu === 'spcountry');
		if ($user->authorise('country.access', 'com_spcountry') && $user->authorise('country.submenu', 'com_spcountry'))
		{
			JHtmlSidebar::addEntry(JText::_('COM_SPCOUNTRY_SUBMENU_COUNTRIES'), 'index.php?option=com_spcountry&view=countries', $submenu === 'countries');
		}
	}
	...
	*/
	 ...
	 *
	 */
	public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'spcountry')
	{
		if(!$where)
		{
	 ...
	 *
	 */
	public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'spcountry', $unique = true)
	{
		if(!$where)
		{
			$where = JFactory::getUser()->id;
	...
	public static function isPublished($id,$type)
	{
		...
		$query->from('#__spcountry_'.$type.' AS a');
	 ...
	 * 
	 */
	public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'spcountry', $user = 'null')
	{
	 ...
	 */
	public static function getModel($name, $path = JPATH_COMPONENT_ADMINISTRATOR, $Component = 'Spcountry', $config = array())
	{
		// fix the name
	...
	public static function setAsset($id, $table, $inherit = true)
	{
		...
		$parent->loadByName('com_spcountry');
		
		$parentId = $parent->id;
		$name     = 'com_spcountry.'.$table.'.'.$id;
		$title    = '';
		...
		else
		{
			...
			$rules = self::getDefaultAssetRules('com_spcountry', $table, $inherit);
			...
			else
			{
				...
				return JFactory::getDbo()->updateObject('#__spcountry_'.$table, $object, 'id');
			}
		}
		return false;
	}
	...
	public static function transliterate($string)
	{
		...
		{
			// get global value
			self::$langTag = JComponentHelper::getParams('com_spcountry')->get('language', 'en-GB');
		}
