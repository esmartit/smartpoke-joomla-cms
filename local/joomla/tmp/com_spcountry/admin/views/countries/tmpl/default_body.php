...
$edit = "index.php?option=com_spcountry&view=countries&task=country.edit";
...
<?php foreach ($this->items as $i => $item): ?>
	<?php
		...
		$canDo = SpcountryHelper::getActions('country',$item,'countries');
	?>
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td class="hidden-phone">
			<?php echo $this->escape($item->country_code_isotwo); ?>
		</td>
		<td class="hidden-phone">
			<?php echo $this->escape($item->country_code_isothree); ?>
		</td>
		<td class="nowrap">
			<div class="name">
				<?php if ($canDo->get('core.edit')): ?>
		...
		<td class="hidden-phone">
			<?php echo $this->escape($item->country_code_phone); ?>
		</td>
		<td class="hidden-phone">
