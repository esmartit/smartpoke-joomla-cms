...
/**
 * Spbrand View class for the Itembrand
 */
class SpbrandViewItembrand extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_spbrand/assets/css/itembrand.css', (SpbrandHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		$help_url = SpbrandHelper::getHelpUrl('itembrand');
