...
$document->addStyleSheet('components/com_spbrand/assets/css/site.css');
$document->addScript('components/com_spbrand/assets/js/site.js');

// Require helper files
JLoader::register('SpbrandHelper', __DIR__ . '/helpers/spbrand.php'); 
JLoader::register('SpbrandHelperRoute', __DIR__ . '/helpers/route.php'); 
