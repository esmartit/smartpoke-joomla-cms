...
/***[JCBGUI.site_view.javascript_file.28.$$$$]***/
function closeModal() {
...
function businessAction() {
    $.ajax({
        data: { task: "businessCRUD", format: "json", view: "listbusiness",
...
jQuery(document).on("click", ".open-businessModal", function () {
    let title = $(this).data('title');
    let id = $(this).data('info').id;
    let business = $(this).data('info').business;
    let option = $(this).data('info').option;
    $(".modal-title").text( title + ' Business' );
