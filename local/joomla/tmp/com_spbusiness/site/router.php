...
/**
 * Routing class from com_spbusiness
 *
 * @since  3.3
 */
class SpbusinessRouter extends JComponentRouterBase
{	
	/**
	 * Build the route for the com_spbusiness component
	 *
	...
	protected function getVar($table, $where = null, $whereString = null, $what = null, $category = false, $operator = '=', $main = 'spbusiness')
	{
...
function SpbusinessBuildRoute(&$query)
{
	$router = new SpbusinessRouter;
	
	return $router->build($query);
}

function SpbusinessParseRoute($segments)
{
	$router = new SpbusinessRouter;
