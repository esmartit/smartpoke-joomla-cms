...
/**
 * Spbusiness View class for the Itembusiness
 */
class SpbusinessViewItembusiness extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_spbusiness/assets/css/itembusiness.css', (SpbusinessHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		$help_url = SpbusinessHelper::getHelpUrl('itembusiness');
