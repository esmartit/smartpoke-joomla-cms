                                ...
                                <tbody>
                                    <?php foreach ($this->items as $item): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class=" last">
                                                <a type="button" class="open-businessModal btn-sm btn-outline-secondary" data-toggle="modal" data-target="#businessModal" data-title="View" data-info='{"id":"<?php echo $item->id; ?>", "business":"<?php echo $item->name; ?>", "option":"R"}'><i class="fa fa-eye"></i></a>
                                                <?php if ($canDo->get('core.edit')): ?>
                                                    <a type="button" class="open-businessModal btn-sm btn-outline-secondary" data-toggle="modal" data-target="#businessModal" data-title="Edit" data-info='{"id":"<?php echo $item->id; ?>", "business":"<?php echo $item->name; ?>", "option":"U"}'><i class="fa fa-edit"></i></a>
                                                <?php endif; ?>
                                                <?php if ($canDo->get('core.delete')): ?>
                                                    <a type="button" class="open-businessModal btn-sm btn-outline-secondary" data-toggle="modal" data-target="#businessModal" data-title="Delete" data-info='{"id":"<?php echo $item->id; ?>", "business":"<?php echo $item->name; ?>", "option":"D"}'><i class="fa fa-trash"></i></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
...
<div class="modal fade" id="businessModal" tabindex="-1" role="dialog" aria-labelledby="businessModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="businessModalLabel">Brand</h5>
