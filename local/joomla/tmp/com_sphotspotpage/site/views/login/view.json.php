...
class SpHotSpotPageViewLogin extends JViewLegacy
{
    /**
     */
    ...
    function display($tpl = null)
    {
        ...
        if ( $validMobile != 1 ) {
            $arr_result[] = array("section" => "error", "data" => Jtext::_('COM_SPHOTSPOTPAGE_ERROR_PHONE'));
        } else {
...
//                    $resultSMS = trim(self::sendWorldLine($phoneSMS,  $messageSMS, 'SmartPoke', '', $unicode)); // WorldLine Web SMS
                ...
                if ($status == 1) {
                    ...
                    $arr_result[] = array("section" => "error", "data" => Jtext::_('COM_SPHOTSPOTPAGE_ERROR_MSG'));
                }
            }
        }
