...
if ($isLoginRequest) {
    ...
    $groupname = 'S1';
    $hotspot_title = '"Navega de manera segura a través de nuestra red wifi y disfruta de tu estancia en Bahía Plaza"';
    $hotspot_name = 'Bahia Plaza';
    $spot_id = 'silicius001';
    ...
    <?php if ($isLoginRequest) { ?>
        <div class="row-fluid">
            <div class="span12" align="center">
                <h4 class="form-signin-heading"><i><?php echo $hotspot_title; ?></i></h4>
...
<!--                                </td>-->
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn btn-primary"><?php echo JText::_('Soy mayor de 16 años'); ?></button></td>
                            </tr>
                            <tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 100px; overflow-y: auto;">
                ...
                <p><b>Bahia Plaza</b> no garantiza el nivel de funcionamiento de la red WI-FI. El servicio puede no estar disponible o ser limitado en cualquier momento y por cualquier motivo, incluyendo emergencias, sobre carga de conexiones, fallo del enlace, problemas en equipos de red, interferencias o fuerza de la señal.</p>
                <p><b>Bahia Plaza</b>, no se responsabiliza por datos, mensajes o páginas perdidas, no guardadas o retrasos por interrupciones o problemas de rendimiento con el servicio.</p>
                <p><b>Bahia Plaza</b>, puede establecer límites de uso, suspender el servicio o bloquear ciertos comportamientos, acceso a ciertos servicios o dominios para proteger la red del establecimiento de fraudes o actividades que atenten contra las leyes nacionales o internacionales.</p>
