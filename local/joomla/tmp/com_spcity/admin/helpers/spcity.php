...
/**
 * Spcity component helper.
 */
abstract class SpcityHelper
{
	/**
	 * Composer Switch
	 * 
	...
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_spcity/spcity.xml";
	...
	{
		// get params
		$params	= JComponentHelper::getParams('com_spcity');
	...
	public static function addSubmenu($submenu)
	{
		...
		JHtmlSidebar::addEntry(JText::_('COM_SPCITY_SUBMENU_DASHBOARD'), 'index.php?option=com_spcity&view=spcity', $submenu === 'spcity');
		if ($user->authorise('city.access', 'com_spcity') && $user->authorise('city.submenu', 'com_spcity'))
		{
			JHtmlSidebar::addEntry(JText::_('COM_SPCITY_SUBMENU_CITIES'), 'index.php?option=com_spcity&view=cities', $submenu === 'cities');
		}
	}
	...
	*/
	 ...
	 *
	 */
	public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'spcity')
	{
		if(!$where)
		{
	 ...
	 *
	 */
	public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'spcity', $unique = true)
	{
		if(!$where)
		{
			$where = JFactory::getUser()->id;
	...
	public static function isPublished($id,$type)
	{
		...
		$query->from('#__spcity_'.$type.' AS a');
	 ...
	 * 
	 */
	public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'spcity', $user = 'null')
	{
	 ...
	 */
	public static function getModel($name, $path = JPATH_COMPONENT_ADMINISTRATOR, $Component = 'Spcity', $config = array())
	{
		// fix the name
	...
	public static function setAsset($id, $table, $inherit = true)
	{
		...
		$parent->loadByName('com_spcity');
		
		$parentId = $parent->id;
		$name     = 'com_spcity.'.$table.'.'.$id;
		$title    = '';
		...
		else
		{
			...
			$rules = self::getDefaultAssetRules('com_spcity', $table, $inherit);
			...
			else
			{
				...
				return JFactory::getDbo()->updateObject('#__spcity_'.$table, $object, 'id');
			}
		}
		return false;
	}
	...
	public static function transliterate($string)
	{
		...
		{
			// get global value
			self::$langTag = JComponentHelper::getParams('com_spcity')->get('language', 'en-GB');
		}
