...
class SpcustomerViewListcustomer extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_spcustomer/assets/css/listcustomer.css', (SpcustomerHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		$help_url = SpcustomerHelper::getHelpUrl('listcustomer');
