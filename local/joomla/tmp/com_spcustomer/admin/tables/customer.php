 ...
 */
class SpcustomerTableCustomer extends JTable
{
	/**
	...
	{
		parent::__construct('#__spcustomer_customer', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_spcustomer.customer'));
	}	
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New customer. A customer created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_SPCUSTOMER_CUSTOMER_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_spcustomer.customer.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_spcustomer.customer.'.(int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = NULL, $id = NULL) 
	{
		...
		$asset->loadByName('com_spcustomer');
