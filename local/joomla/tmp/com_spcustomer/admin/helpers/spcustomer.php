...
/**
 * Spcustomer component helper.
 */
abstract class SpcustomerHelper
{
	/**
	 * Composer Switch
	 * 
	...
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_spcustomer/spcustomer.xml";
	...
	{
		// get params
		$params	= JComponentHelper::getParams('com_spcustomer');
	...
	public static function addSubmenu($submenu)
	{
		...
		JHtmlSidebar::addEntry(JText::_('COM_SPCUSTOMER_SUBMENU_DASHBOARD'), 'index.php?option=com_spcustomer&view=spcustomer', $submenu === 'spcustomer');
		if ($user->authorise('customer.access', 'com_spcustomer') && $user->authorise('customer.submenu', 'com_spcustomer'))
		{
			JHtmlSidebar::addEntry(JText::_('COM_SPCUSTOMER_SUBMENU_CUSTOMERS'), 'index.php?option=com_spcustomer&view=customers', $submenu === 'customers');
		}
	}
	...
	*/
	 ...
	 *
	 */
	public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'spcustomer')
	{
		if(!$where)
		{
	 ...
	 *
	 */
	public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'spcustomer', $unique = true)
	{
		if(!$where)
		{
			$where = JFactory::getUser()->id;
	...
	public static function isPublished($id,$type)
	{
		...
		$query->from('#__spcustomer_'.$type.' AS a');
	 ...
	 * 
	 */
	public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'spcustomer', $user = 'null')
	{
	 ...
	 */
	public static function getModel($name, $path = JPATH_COMPONENT_ADMINISTRATOR, $Component = 'Spcustomer', $config = array())
	{
		// fix the name
	...
	public static function setAsset($id, $table, $inherit = true)
	{
		...
		$parent->loadByName('com_spcustomer');
		
		$parentId = $parent->id;
		$name     = 'com_spcustomer.'.$table.'.'.$id;
		$title    = '';
		...
		else
		{
			...
			$rules = self::getDefaultAssetRules('com_spcustomer', $table, $inherit);
			...
			else
			{
				...
				return JFactory::getDbo()->updateObject('#__spcustomer_'.$table, $object, 'id');
			}
		}
		return false;
	}
	...
	public static function transliterate($string)
	{
		...
		{
			// get global value
			self::$langTag = JComponentHelper::getParams('com_spcustomer')->get('language', 'en-GB');
		}
