...
// Access check.
if (!JFactory::getUser()->authorise('core.manage', 'com_spcustomer'))
{
...
$document->addStyleSheet('components/com_spcustomer/assets/css/admin.css');
$document->addScript('components/com_spcustomer/assets/js/admin.js');
