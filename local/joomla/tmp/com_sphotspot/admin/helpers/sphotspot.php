...
/**
 * Sphotspot component helper.
 */
abstract class SphotspotHelper
{
	/**
	 * Composer Switch
	 * 
	...
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_sphotspot/sphotspot.xml";
	...
	{
		// get params
		$params	= JComponentHelper::getParams('com_sphotspot');
	...
	public static function addSubmenu($submenu)
	{
		...
		JHtmlSidebar::addEntry(JText::_('COM_SPHOTSPOT_SUBMENU_DASHBOARD'), 'index.php?option=com_sphotspot&view=sphotspot', $submenu === 'sphotspot');
	}
	...
	*/
	 ...
	 *
	 */
	public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'sphotspot')
	{
		if(!$where)
		{
	 ...
	 *
	 */
	public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'sphotspot', $unique = true)
	{
		if(!$where)
		{
			$where = JFactory::getUser()->id;
	...
	public static function isPublished($id,$type)
	{
		...
		$query->from('#__sphotspot_'.$type.' AS a');
	 ...
	 * 
	 */
	public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'sphotspot', $user = 'null')
	{
	 ...
	 */
	public static function getModel($name, $path = JPATH_COMPONENT_ADMINISTRATOR, $Component = 'Sphotspot', $config = array())
	{
		// fix the name
	...
	public static function setAsset($id, $table, $inherit = true)
	{
		...
		$parent->loadByName('com_sphotspot');
		
		$parentId = $parent->id;
		$name     = 'com_sphotspot.'.$table.'.'.$id;
		$title    = '';
		...
		else
		{
			...
			$rules = self::getDefaultAssetRules('com_sphotspot', $table, $inherit);
			...
			else
			{
				...
				return JFactory::getDbo()->updateObject('#__sphotspot_'.$table, $object, 'id');
			}
		}
		return false;
	}
	...
	public static function transliterate($string)
	{
		...
		{
			// get global value
			self::$langTag = JComponentHelper::getParams('com_sphotspot')->get('language', 'en-GB');
		}
