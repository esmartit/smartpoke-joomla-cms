 ...
 * Zones Table class
 */
class SpzoneTableZone extends JTable
{
	/**
	...
	{
		parent::__construct('#__spzone_zone', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_spzone.zone'));
	}	
	...
	/**
	 * Overload the store method for the Zone table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New zone. A zone created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_SPZONE_ZONE_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_spzone.zone.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_spzone.zone.'.(int) $this->$k;
	}
