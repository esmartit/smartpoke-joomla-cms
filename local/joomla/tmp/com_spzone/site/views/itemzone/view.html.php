...
/**
 * Spzone View class for the Itemzone
 */
class SpzoneViewItemzone extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_spzone/assets/css/itemzone.css', (SpzoneHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		$help_url = SpzoneHelper::getHelpUrl('itemzone');
