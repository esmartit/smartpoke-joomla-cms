...
$document->addStyleSheet('components/com_splashpage/assets/css/site.css');
$document->addScript('components/com_splashpage/assets/js/site.js');
...
$controller = JControllerLegacy::getInstance('Splashpage');
