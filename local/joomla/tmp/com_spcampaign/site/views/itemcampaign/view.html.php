...
/**
 * Spcampaign View class for the Itemcampaign
 */
class SpcampaignViewItemcampaign extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_spcampaign/assets/css/itemcampaign.css', (SpcampaignHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		$help_url = SpcampaignHelper::getHelpUrl('itemcampaign');
