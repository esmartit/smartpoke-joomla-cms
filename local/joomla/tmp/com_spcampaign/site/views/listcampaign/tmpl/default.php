...
?>
<form action="<?php echo JRoute::_('index.php?option=com_spcampaign'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <?php if ($this->user->authorise('core.create', 'com_spcampaign')): ?>
                <a href="?option=com_spcampaign&view=campaign&layout=edit" class="btn btn-light"><?php echo JText::_('COM_SPCAMPAIGN_NEW_CAMPAIGN'); ?></a>
                <br />
            <?php endif; ?>
            <div class="x_content">
                <div class="row">
...
<!--                                            <td class="">--><?php //echo $item->message_sms; ?><!--</td>-->
                                        ...
                                        <?php else : ?>
                                            ...
                                            <td class=""><?php echo $item->deferreddate; ?></td>
                                        <?php endif; ?>
                                        <td class=" last">
                                            <a href="<?php echo JRoute::_(SpcampaignHelperRoute::getItemcampaignRoute($item->slug)); ?>" class="btn-sm btn-outline-secondary"><i class="fa fa-eye"></i></a>
                                            <?php if ($canDo->get('core.edit')): ?>
                                                <a href="index.php?option=com_spcampaign&view=campaigns&task=campaign.edit&id=<?php echo $item->id; ?>" class="btn-sm btn-outline-secondary"><i class="fa fa-edit"></i></a>
                                            <?php endif; ?>
