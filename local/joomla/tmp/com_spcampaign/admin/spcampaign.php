...
// Access check.
if (!JFactory::getUser()->authorise('core.manage', 'com_spcampaign'))
{
...
$document->addStyleSheet('components/com_spcampaign/assets/css/admin.css');
$document->addScript('components/com_spcampaign/assets/js/admin.js');
