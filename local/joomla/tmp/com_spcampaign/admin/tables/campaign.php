 ...
 */
class SpcampaignTableCampaign extends JTable
{
	/**
	...
	{
		parent::__construct('#__spcampaign_campaign', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_spcampaign.campaign'));
	}	
	...
	/**
	 * Overload the store method for the Campaign table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New campaign. A campaign created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_SPCAMPAIGN_CAMPAIGN_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_spcampaign.campaign.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_spcampaign.campaign.'.(int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = NULL, $id = NULL) 
	{
		...
		$asset->loadByName('com_spcampaign');
