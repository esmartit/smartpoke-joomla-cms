...
/**
 * General Controller of Spdevice component
 */
class SpdeviceController extends JControllerLegacy
{
	...
	function display($cachable = false, $urlparams = false)
	{
		...
		$view   = $this->input->getCmd('view', 'spdevice');
		...
		{
			if ($data['edit'] && $layout == 'edit' && !$this->checkEditId('com_spdevice.edit.'.$data['view'], $id))
			{
				...
				else
				{
					...
					$this->setRedirect(JRoute::_('index.php?option=com_spdevice&view='.$data['views'], false));
				}
