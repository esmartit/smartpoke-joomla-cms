...
abstract class SpnasHelper
{
	...
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_spnas/spnas.xml";
	...
	public static function addSubmenu($submenu)
	{
		...
		JHtmlSidebar::addEntry(JText::_('COM_SPNAS_SUBMENU_DASHBOARD'), 'index.php?option=com_spnas&view=spnas', $submenu === 'spnas');
	}
...
//	}
	 ...
	 * 
	 */
	public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'spnas', $user = 'null')
	{
	 ...
	 */
	public static function getModel($name, $path = JPATH_COMPONENT_ADMINISTRATOR, $Component = 'Spnas', $config = array())
	{
		// fix the name
...
//	}
	...
	public static function transliterate($string)
	{
		...
		{
			// get global value
			self::$langTag = JComponentHelper::getParams('com_spnas')->get('language', 'en-GB');
		}
