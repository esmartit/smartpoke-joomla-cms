...
// Access check.
if (!JFactory::getUser()->authorise('core.manage', 'com_spnas'))
{
...
$document->addStyleSheet('components/com_spnas/assets/css/admin.css');
$document->addScript('components/com_spnas/assets/js/admin.js');
