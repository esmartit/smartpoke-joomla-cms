...
/**
 * Spnas View class for the Itemnas
 */
class SpnasViewItemnas extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_spnas/assets/css/itemnas.css', (SpnasHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		$help_url = SpnasHelper::getHelpUrl('itemnas');
	...
	public function escape($var, $sorten = false, $length = 40)
	{
		...
		return SpnasHelper::htmlEscape($var, $this->_charset, $sorten, $length);
	}
}
