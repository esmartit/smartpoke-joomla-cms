...
$document->addScript('/media/mod_spreporthotspotcomparative/js/spreporthotspotcomparative.js');
            ...
            <form id="hotspotdetail_report_form" class="form-horizontal form-label-left" method="POST">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <br/>
                            <select name="country" class="countries order-alpha form-control" id="countryId" onchange="setHotSpotCity()">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <br/>
                            <select name="state" class="states order-alpha form-control" id="stateId" onchange="setHotSpotCity()">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <br/>
                            <select name="city" class="cities order-alpha form-control" id="cityId" onblur="getHotSpotCity()">
