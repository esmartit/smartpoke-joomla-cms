...
$(document).ready( function() {
    ...
    let seDailyGoal = new EventSource("/index.php?option=com_spserverevent&format=json&base_url=ms_data&resource_path=/sensor-activity/v2/today-detected-count?startDate="+dateS+"%26endDate="+dateE+"%26brands="+encodeURIComponent(brands));
