...
?>
<form action="<?php echo JRoute::_('index.php?option=com_spvalue'); ?>" method="post" name="adminForm" id="adminForm">
    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <?php if ($this->user->authorise('core.create', 'com_spvalue')): ?>
                <a href="?option=com_spvalue&view=value&layout=edit" class="btn btn-light"><?php echo JText::_('COM_SPVALUE_NEW_VALUE'); ?></a>
                <br />
            <?php endif; ?>
            <div class="x_content">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                <tr class="headings">
                                    <th class='column-title'><?php echo JText::_('COM_SPVALUE_ID'); ?></th>
                                ...
                                <?php foreach ($this->items as $item): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class=" last">
                                            <a href="<?php echo JRoute::_(SpvalueHelperRoute::getItemvalueRoute($item->slug)); ?>" class="btn-sm btn-outline-secondary"><i class="fa fa-eye"></i></a>
                                            <?php if ($canDo->get('core.edit')): ?>
                                                <a href="index.php?option=com_spvalue&view=values&task=value.edit&id=<?php echo $item->id; ?>" class="btn-sm btn-outline-secondary"><i class="fa fa-edit"></i></a>
                                            <?php endif; ?>
