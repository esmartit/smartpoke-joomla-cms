...
/**
 * Spvalue View class for the Itemvalue
 */
class SpvalueViewItemvalue extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_spvalue/assets/css/itemvalue.css', (SpvalueHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		$help_url = SpvalueHelper::getHelpUrl('itemvalue');
