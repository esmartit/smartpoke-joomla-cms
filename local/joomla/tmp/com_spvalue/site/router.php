...
/**
 * Routing class from com_spvalue
 *
 * @since  3.3
 */
class SpvalueRouter extends JComponentRouterBase
{	
	/**
	 * Build the route for the com_spvalue component
	 *
	...
	protected function getVar($table, $where = null, $whereString = null, $what = null, $category = false, $operator = '=', $main = 'spvalue')
	{
...
function SpvalueBuildRoute(&$query)
{
	$router = new SpvalueRouter;
	
	return $router->build($query);
}

function SpvalueParseRoute($segments)
{
	$router = new SpvalueRouter;
