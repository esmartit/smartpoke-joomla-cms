 ...
 * @subpackage  mod_spselectreportbigdatadetaildaily
 *
...
$document->addScript('/media/mod_spreportbigdatadetaildaily/js/spreportbigdatadetaildaily.js');
    ...
    <div class="col-md-12 col-sm-12 ">
        <p>
            <a class="btn btn-outline-secondary" data-toggle="collapse" href="#collapseSelect" role="button" aria-expanded="false" aria-controls="collapseSelect">
                <?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY');?>
            </a>
        </p>
...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_DETAIL');?> <small></small></h2>
                ...
                <div class="col-sm-12">
                    <div class="card-box table-responsive">
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            <thead>
                            <tr class="headings">
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_SPOT'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_SENSOR'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_DEVICE'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_USERNAME'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_DATE'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_MINTIME'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_MAXTIME'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_TOTALTIME'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_STATUS'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_GENDER'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_AGE'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_USERZIPCODE'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_COUNTRY'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_STATE'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_CITY'); ?></th>
                                <th class='column-title'><?php echo JText::_('MOD_SPREPORTBIGDATADETAILDAILY_ZIPCODE'); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
